export function DeveloperBar(){
 return <div className="developerBar" aria-label="NOVA developer links">
   <div className="developerShine"/>
   <span className="developerLabel">Developed by</span>
   <strong>Belal Algebaly</strong>
   <span className="developerLinks">
